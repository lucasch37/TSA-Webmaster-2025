...
const IMAGES = {
  dinnerParty: "https://images.unsplash.com/photo-1414235077428-338989a2e8c0?q=80&w=3870&auto=format&fit=crop",
  opening: "https://images.unsplash.com/photo-1552566626-52f8b828add9?q=80&w=3870&auto=format&fit=crop",
      ...
      <div className="pt-16">
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-sage-800 leading-snug">
                Crafting a sustainable future through innovative vegetarian cuisine
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="relative py-12">
          <div className="max-w-7xl mx-auto px-4">
            ...
            >
              <h2 className="text-3xl font-bold text-sage-950">Redefining Plant-Based Dining</h2>
              <p className="text-lg text-sage-800 leading-relaxed">
                At Sprout, we believe that vegetarian cuisine can be both extraordinary and sustainable. 
                Our journey began with a simple idea: to create a dining experience that celebrates the 
                power of plants while nurturing our community and planet.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="relative py-20">
          <div className="max-w-7xl mx-auto px-4">
            ...
            >
              <div>
                <h2 className="text-4xl font-bold text-sage-950 mb-4">Our Impact</h2>
                <p className="text-xl text-sage-800">Making a difference, one plate at a time</p>
              </div>
              
              <div className="grid md:grid-cols-3 gap-12">
                <ImpactStat number="15,000+" label="Local Produce (lbs)" description="Sourced directly from local farmers" />
                <ImpactStat number="30%" label="Carbon Footprint" description="Reduction in our first year" />
                <ImpactStat number="1,000+" label="Community Members" description="Engaged in our programs" />
              </div>
            </motion.div>
          </div>
        </section>
        ...
        <section className="relative py-20">
          <div className="max-w-7xl mx-auto px-4 text-center">
            <motion.div
              ...
              className="space-y-8"
            >
              <h2 className="text-4xl font-bold text-sage-950">Join Our Journey</h2>
              <p className="text-xl text-sage-800 max-w-2xl mx-auto">
                Experience the future of dining at Sprout. Every meal is an opportunity to make a difference.
              </p>
              <motion.button
...
function TimelineItem({ year, title, description, image, isImageLeft }: {
  year: string;
  title: string;
  description: string;
  image: string;
...
function ImpactStat({ number, label, description }: {
  number: string;
  label: string;
  description: string;
}) {
